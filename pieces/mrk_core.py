"""
Lightweight MRK helpers shared by BatterySimulationPiece (and others).

Avoids importing the full SimulateMRKScenarioPiece module (~1800 lines) in small
pieces, which can OOM or timeout on Domino with 128MB limits.
"""
...
def build_price_series(df: pd.DataFrame, cfg: dict) -> pd.Series:
    del cfg  # reserved for future tariff rules
